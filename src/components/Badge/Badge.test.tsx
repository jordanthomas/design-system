...
describe('<Badge />', () => {
  describe('Badge content', () => {
    it('yields the content provided', () => {
      const wrapper = shallow(<Badge>Sheriff</Badge>);
  ...
  describe('Badge style', () => {
    ...
    it('renders the badge with the provided style class', () => {
      const wrapper = shallow(<Badge status="negative">Sheriff</Badge>);
    ...
    it('renders the badge with the provided combination of classes', () => {
      ...
      expect(wrapper.prop('className')).toEqual(
        'badge badge--mini badge--negative another-class and-another'
      );
    });
  });
});
