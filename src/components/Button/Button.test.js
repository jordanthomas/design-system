...
describe('<Button />', () => {
  ...
  describe('Button style', () => {
    ...
    it('renders the button with the provided combination of classes', () => {
      const wrapper = shallow(
        <Button buttonDisplay="block" buttonStyle="secondary" buttonSize="xl" className="another-class and-another">
          Easy
        </Button>
      );
      expect(wrapper.prop('className')).toEqual('btn btn--block btn--xl btn--secondary another-class and-another');
    });
  });
